...
const projectsEn = [
  {
    ...
    image: sisvet,
    icon: basculas,
    source_code_link: "https://play.google.com/store/apps/details?id=com.montecarloti.sisvet&hl=es_MX",
  },
  {
    name: "Novapak 365",
    description:
    ...
    image: novapak365,
    icon: novapak,
    source_code_link: "https://play.google.com/store/apps/details?id=com.aplicaciones.appnova&hl=es_MX",
  },
  {
  ...
  },
  {
    ...
    description: "Portfolio website built with Three.js and React.js, with backend integration in MongoDB and Express.",
    tags: [
      {
        name: "Three.js",
        color: "pink-text-gradient",
...
const projectsEs = [
  ...
  },
  {
    ...
    description: "Sitio web de portafolio con Three.js y React.js, con integracion de backend en MongoDB y Express.",
    tags: [
      {
        name: "Three.js",
        color: "pink-text-gradient",
